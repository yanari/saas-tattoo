        ...
        const services = [
            {
                ...
                description:
                    'Tatuagens clássicas com traços e cores marcantes.',
                price: 300.0,
                imageUrl:
            ...
            },
            {
                name: 'Blackwork',
                description:
                    'Tatuagens em preto sólido com uma estética ousada.',
                price: 250.0,
                imageUrl:
            ...
            },
            {
                name: 'Fineline',
                description:
                    'Detalhes finos e precisos para um resultado delicado.',
                price: 200.0,
                imageUrl:
            ...
            },
            {
                name: 'Aquarela',
                description:
                    'Tatuagens com efeitos de aquarela e cores vibrantes.',
                price: 350.0,
                imageUrl:
            ...
            },
            {
                name: 'Piercing',
                description:
                    'A perfuração mais estilosa para completar seu look.',
                price: 80.0,
                imageUrl:
